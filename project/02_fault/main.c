 ...
 *   3. 向 0xFFFFFFFF 写内存 → 精确总线错误（BusFault）。本工程的
 *      startup.c 从未在 SHCSR 里使能 BusFault/UsageFault/MemManage
...
int main(void)
{
    ...
    printf("triggering bus fault (write 0xFFFFFFFF)...\n");
    volatile uint32_t *p = (volatile uint32_t *)0xFFFFFFFFu;
